...
public class LoginActivity extends BaseActivity {
				...
				new EMCallBack() {
					...
					public void onSuccess() {
						...
						DemoApplication.getInstance().setPassword(
								currentPassword);
						initData(currentUsername, currentPassword);
						try {
	...
	private void initData(final String username, String password) {
		...
		String url = "http://119.29.98.34:8080/chat/user/login.do";
				...
				jsonObject, new Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						...
						if (showMovieMessage.getStatus() == 0) {
							SharedPrefsUtil.putUserId(LoginActivity.this,
									showMovieMessage.getData().getId() + "");
							SharedPrefsUtil.putUserName(LoginActivity.this,
									username + "");
						} else {
						}
						Log.e("response", "response");

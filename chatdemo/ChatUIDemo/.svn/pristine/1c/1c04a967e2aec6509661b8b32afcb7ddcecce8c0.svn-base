...
import com.easemob.chatuidemo.myui.FirendFragment;
import com.easemob.chatuidemo.myui.MySettingsFragment;
...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	private MySettingsFragment settingFragment;
	private FirendFragment friendFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		friendFragment = new FirendFragment();
		fragments = new Fragment[] { chatHistoryFragment, contactListFragment,
				friendFragment, settingFragment };
		// 添加显示第一个fragment
	...
	private void initView() {
		...
		mTabs[2] = (Button) findViewById(R.id.btn_friend);

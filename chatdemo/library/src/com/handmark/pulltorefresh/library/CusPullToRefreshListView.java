...
public class CusPullToRefreshListView extends
	...
	public CusPullToRefreshListView(Context context) {
		super(context);
	}

	public CusPullToRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CusPullToRefreshListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(CusPullToRefreshListView.this, deltaX,
	...
	protected class InternalListView extends ListView implements
		...
		public void setEmptyView(View emptyView) {
			CusPullToRefreshListView.this.setEmptyView(emptyView);
		}

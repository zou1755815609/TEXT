...
import com.wyy.twodimcode.decoding.RGBLuminanceSource;
import com.wyy.twodimcode.view.ViewfinderView;

public class CaptureActivity extends Activity implements Callback {
	public static final int REQUEST_CODE = 1;
	protected static final int PARSE_BARCODE_SUC = 2;
	protected static final int PARSE_BARCODE_FAIL = 3;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_back = (ImageView) findViewById(R.id.iv_twodimcode_back);
		tv_photos = (TextView) findViewById(R.id.tv_twodimcode_photos);
		...
		iv_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				finish();
				CaptureActivity.this.overridePendingTransition(R.anim.trans_pre_in, R.anim.trans_pre_out);
			}
		});
	...
	private void backToPre(String str2) {
		Log.e("str2", str2+"===");
		if (str2.equals("")) {
